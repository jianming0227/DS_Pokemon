...
//    }
        ...
        //set the icon logo
        ImageIcon image = new ImageIcon("C:\\Users\\ljmwa\\OneDrive - Universiti Malaya\\OneDrive\\Documents\\NetBeansProjects\\Pokemon1\\src\\main\\java\\com\\mycompany\\pokemon1\\picture\\poke.jpg"); // create an ImageIcon
        ...
        //adjust the image size
         ...
         ImageIcon originalIcon = new ImageIcon("C:\\Users\\ljmwa\\OneDrive - Universiti Malaya\\OneDrive\\Documents\\NetBeansProjects\\Pokemon1\\src\\main\\java\\com\\mycompany\\pokemon1\\picture\\pokemap2.png");
        ...
        Font customFont = null;
            try {
        customFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\Users\\ljmwa\\OneDrive - Universiti Malaya\\OneDrive\\Documents\\NetBeansProjects\\Pokemon1\\src\\main\\java\\com\\mycompany\\pokemon1\\Abhaya_Libre,Press_Start_2P\\Press_Start_2P\\PressStart2P-Regular.ttf")).deriveFont(Font.PLAIN,30);
        ...
        ImageIcon overlayIcon = new ImageIcon("C:\\Users\\ljmwa\\OneDrive - Universiti Malaya\\OneDrive\\Documents\\NetBeansProjects\\Pokemon1\\src\\main\\java\\com\\mycompany\\pokemon1\\picture\\redFInal.png");
...
//  //keyListener
   ...
   public void keyTyped(KeyEvent e) {
    ...
    int y = overlayLabel.getY();
        ...
        switch(e.getKeyChar()) {
            case 'a' : overlayLabel.setLocation(x-5 ,y);
                break;
            case 'd' : overlayLabel.setLocation(x+5 ,y);
                break;
            case 'w' : overlayLabel.setLocation(x ,y-5);
                break;
            case 's' : overlayLabel.setLocation(x ,y+5);
                break;
        }
...
if(e.getSource()==myButton){
    if (Math.abs(overlayLabel.getX() - destinationX) <= tolerance && Math.abs(overlayLabel.getY() - destinationY) <= tolerance) {
        ...
        congratsWindow myWindow = new congratsWindow();
    } else {
        WrongDestination wrongWindow = new WrongDestination();
    }
}
    }
